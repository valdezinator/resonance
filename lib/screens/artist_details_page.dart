  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawGlowingBlob(
      ...
      for (var i = 0; i < spikes; i++) {
        ...
        final controlX =
            center.dx + radius * 1.5 * math.cos((angle + nextAngle) / 2);
        final controlY =
            center.dy + radius * 1.5 * math.sin((angle + nextAngle) / 2);
...
class _ArtistDetailsPageState extends ConsumerState<ArtistDetailsPage>
  ...
  void initState() {
    super.initState();
    print(
        'Artist data from recommended_artists: ${widget.artist}'); // Debug log
    loadArtistData();
  ...
  Future<void> loadArtistData() async {
    try {
      ...
      final artistName = widget
          .artist['artist']; // This is the field name in recommended_artists
                        ...
                        children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(5),
                                    child: artistData?[
                                                'latest_release_album_image_url'] !=
                                            null
                                        ? Image.network(
                                            artistData![
                                                'latest_release_album_image_url'],
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          artistData?[
                                                  'latest_release_album_url'] ??
                                              'Album name unavailable',
                                          style: GoogleFonts.lato(
                                            color: themeProvider
                                                .getPrimaryTextColor(),
                          ...
                          Padding(
                            padding: const EdgeInsets.fromLTRB(20, 20, 20,
                                4), // Changed bottom padding from 8 to 4
                            child: Text(
                              'Top Songs',
                              style: GoogleFonts.raleway(
                                fontSize: 24,
                          ...
                          Padding(
                            ...
                            child: GridView.builder(
                              ...
                              gridDelegate:
                                ...
                                crossAxisCount: 2,
                                childAspectRatio:
                                    0.7, // Adjusted to give more space for text
                                crossAxisSpacing: 15,
                                mainAxisSpacing: 15,
                              ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () =>
                            setState(() => showFullDetails = false),
                        child: Text(
                          'Close',
                          style: TextStyle(
                            color: Colors.blue,
